...
#ifndef FOSSSWEEPER_LCDNUMBER_HPP
#define FOSSSWEEPER_LCDNUMBER_HPP
...
struct LcdNumber {
  int _number = 0;
  fosssweeper::LcdDigit _digits[3] = {
      fosssweeper::LcdDigit::None,
      fosssweeper::LcdDigit::None,
      fosssweeper::LcdDigit::None,
  };
  ...
  fosssweeper::LcdDigit operator[](std::size_t digit_i) const;

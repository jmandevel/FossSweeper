...
#ifndef FOSSSWEEPER_SPRITE_HPP
#define FOSSSWEEPER_SPRITE_HPP
...
fosssweeper::Sprite getSpriteFromDigit(fosssweeper::LcdDigit digit) noexcept;
fosssweeper::Sprite getDownButtonSprite(int surrounding_bombs) noexcept;
} // namespace fosssweeper

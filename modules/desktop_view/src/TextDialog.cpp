...
fsweep::TextDialog::TextDialog(wxWindow *parent, std::string_view title,
...
fsweep::TextDialog fsweep::createLicenseDialog(wxWindow *parent) {
  return fsweep::TextDialog(parent, "FossSweeper License",
                            fsweep::LICENSE_TEXT);
}

fsweep::TextDialog fsweep::createCreditsDialog(wxWindow *parent) {
  return fsweep::TextDialog(parent, "FossSweeper Credits",
                            fsweep::CREDITS_TEXT);
}
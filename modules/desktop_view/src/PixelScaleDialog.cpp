...
fsweep::PixelScaleDialog::PixelScaleDialog(wxWindow *parent, int pixel_scale)
  ...
  Bind(wxEVT_BUTTON, &fsweep::PixelScaleDialog::onCancel, this,
       cancel_button->GetId());
  auto *const confirm_button = new wxButton(this, wxID_OK, "Confirm");
  confirm_button->SetDefault();
  Bind(wxEVT_BUTTON, &fsweep::PixelScaleDialog::onConfirm, this,
...
void fsweep::PixelScaleDialog::onCancel(wxCommandEvent &WXUNUSED(e)) {
  this->EndModal(wxCANCEL);
}

int fsweep::PixelScaleDialog::getPixelScale() const noexcept {

...
fsweep::ConfigDialog::ConfigDialog(wxWindow *parent)
  ...
  this->buttons_wide_ctrl->SetRange(fsweep::GameConfiguration::MIN_BUTTONS_WIDE,
                                    64);
  ...
  this->buttons_tall_ctrl->SetRange(fsweep::GameConfiguration::MIN_BUTTONS_TALL,
                                    64);
  ...
  Bind(wxEVT_BUTTON, &fsweep::ConfigDialog::onCancel, this,
       cancel_button->GetId());
  auto *const confirm_button = new wxButton(this, wxID_OK, "Confirm");
  confirm_button->SetDefault();
  Bind(wxEVT_BUTTON, &fsweep::ConfigDialog::onConfirm, this,
...
void fsweep::ConfigDialog::onCancel(wxCommandEvent &WXUNUSED(e)) {
  this->EndModal(wxCANCEL);
}

int fsweep::ConfigDialog::getButtonsWide() const noexcept {
  return this->buttons_wide;
}

int fsweep::ConfigDialog::getButtonsTall() const noexcept {
  return this->buttons_tall;
}

int fsweep::ConfigDialog::getBombCount() const noexcept {

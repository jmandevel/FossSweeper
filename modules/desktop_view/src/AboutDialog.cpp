...
fsweep::AboutDialog::AboutDialog(wxWindow *parent)
    : wxDialog(parent, wxID_ANY, "About FossSweeper") {
  ...
  auto *const info_text =
      new wxStaticText(this, wxID_ANY,
                       "FossSweeper is released under the GNU General Public "
  ...
  auto *const copy_version_button =
      new wxButton(this, wxID_ANY, "Copy Version");
  Bind(wxEVT_BUTTON, &fsweep::AboutDialog::OnCopyVersion, this,
  ...
  Bind(wxEVT_BUTTON, &fsweep::AboutDialog::OnCopyHash, this,
  ...
  Bind(wxEVT_BUTTON, &fsweep::AboutDialog::OnLicense, this,
  ...
  Bind(wxEVT_BUTTON, &fsweep::AboutDialog::OnCredits, this,
